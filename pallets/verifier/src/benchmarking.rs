...
benchmarks! {
	...
	}: set_zk_keys(origin, public_signal, vk_alpha1, vk_beta_2, vk_gamma_2, vk_delta_2, vk_ic0, vk_ic1)
  ...
  verify_benchmark {
        ...
        Verifier::<T>::set_zk_keys(origin.clone().into(), public_signal, vk_alpha1, vk_beta_2, vk_gamma_2, vk_delta_2, vk_ic0, vk_ic1);
    }: verify(origin, proof_a, proof_b, proof_c)
